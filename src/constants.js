module.exports = Object.freeze({
  QUERIES: {
    ...
    InitialAssessment: {
      page2EAEPost: 'update codelinc.veteran_employment_education set current_occupation =$13,current_employer = $2,current_employer_location =$3 ,previous_occupations =$6,work_skills =$9 ,highest_education_grade =$4 ,school_name =$7,active_military_status =$5,military_branch=$1,discharge_type =$12,service_dates =$10,service_location=$11,other_training_education =$8 where veteran_id = $14',
      page2SocialPost: 'update codelinc.veteran_pi set hobbies = $2, religious_preference = $3 where veteran_id = $1',
      page2MHPost: 'update codelinc.veteran_mental_health set diagnosis=$2 ,current_psych_treatment=$1 ,psychiatrist_name=$12 ,psychiatrist_address=$11 ,psychiatrist_city_state=$14 ,psych_past_treatments=$4 ,psych_consult_needed=$3,psych_evaluation_physician_name=$8 ,psych_evaluation_physician_address =$5 ,psych_evaluation_physician_city=$6 ,psych_evaluation_physician_state=$9 ,psych_evaluation_physician_zipcode=$10 ,psych_evaluation_physician_license =$7 where veteran_id = $13',
      ...
      page5: '',
      page4SubAbu: 'UPDATE codelinc.veteran_substances SET current_alcohol_intake_freq=$1, current_caffeine_use_freq=$2, current_drug_alcohol_treatment=$3, current_drug_use_freq=$4, current_tobacco_use_freq=$5, currently_consumes_alcohol=$6, currently_uses_caffeine=$7, currently_uses_drugs=$8, currently_uses_tobacco=$9, alcohol_history=$10, caffeine_use_history=$11, drug_use_history=$12, tobacco_use_history=$13, drug_alcohol_last_use=$14, treatment_programs=$15, withdrawal_history=$17 where veteran_id=$16',
      page4legal: 'UPDATE codelinc.veteran_legal_history  SET arrest_reason=$1, charges=$2, conviction_reason=$3, current_pending_charges=$4, ever_arrested=$5, ever_convicted=$6, officer_address=$7, officer_name=$8, on_probation_or_parole=$9, outstanding_warrants=$10, probation_or_parole_terms=$11, warrant_reason=$13 where veteran_id  = $12;',
      ...
      getPage5: '',
      getPage4: 'select * from codelinc.veteran_substances vsub natural join codelinc.veteran_legal_history vlh where veteran_id = $1',
      getPage1: 'select * from codelinc.veteran_pi vpi natural join codelinc.veteran_finance vfi natural join codelinc.veteran_health_insurance vhi natural join codelinc.veteran_hist vhist where vpi.veteran_id = $1 and vhi.veteran_id = $1',
      ...
      postIAPage1PI: 'update codelinc.veteran_pi set primary_language = $2 where veteran_id = $1',
      postIAPage1IR: 'update codelinc.veteran_finance set income =$6, income_type =$9,bank_account_type =$2,bank_name =$3,direct_deposit =$5,other_assets =$8,current_benefits=$10 ,needed_benefits=$11 ,cash_benefits =$4,non_cash_benefits =$7 where veteran_id = $1'
    }
  }
});
